...
<html lang="en">
   <head>
      ...
      <link href="{{asset('/backend')}}/assets/css/form.css" rel="stylesheet">
   ...
   <body>
      ...
      <div class="sl-sideleft">
         ...
         <div class="sl-sideleft-menu">
            ...
            <!-- sl-menu-link -->
            <a href="{{asset('/backend')}}/users/all_user.php" class="sl-menu-link">
               <div class="sl-menu-item">
            ...
            <!-- sl-menu-link -->
            <a href="{{asset('/backend')}}/subcategory/all_subcategory.php" class="sl-menu-link ">
               <div class="sl-menu-item">
                  <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            ...
            <!-- sl-menu-link -->
            <a href="{{asset('/backend')}}/product/all_product.php" class="sl-menu-link ">
               <div class="sl-menu-item">
                  <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            ...
            <!-- sl-menu-link -->
            <a href="{{asset('/backend')}}/slider/all_slider.php" class="sl-menu-link ">
               <div class="sl-menu-item">
                  <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            ...
            <!-- sl-menu-link -->
            <a href="{{asset('/backend')}}/calculator/calculator.php" class="sl-menu-link ">
               <div class="sl-menu-item">
                  <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
                  <span class="menu-item-label">Calculator</span>
               </div>
               <!-- menu-item -->
            </a>
            <!-- sl-menu-link -->
         ...
         <div class="sl-header-right">
            <nav class="nav">
               <div class="dropdown">
                  ...
                  <img src="{{asset('/backend')}}/assets/img/img3.jpg" class="wd-32 rounded-circle" alt="">
                  </a>
            ...
            <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
               <div class="media-list">
                  ...
                  <a href="" class="media-list-link">
                     <div class="media">
                        <img src="{{asset('/backend')}}/assets/img/img3.jpg" class="wd-40 rounded-circle" alt="">
                  ...
                  <a href="" class="media-list-link">
                     <div class="media">
                        <img src="{{asset('/backend')}}/assets/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                  ...
                  <a href="" class="media-list-link">
                     <div class="media">
                        <img src="{{asset('/backend')}}/assets/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                  ...
                  <a href="" class="media-list-link">
                     <div class="media">
                        <img src="{{asset('/backend')}}/assets/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
               ...
               <div class="media-list">
                  ...
                  <a href="" class="media-list-link read">
                     <div class="media pd-x-20 pd-y-15">
                        <img src="{{asset('/backend')}}/assets/img/img8.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                  ...
                  <a href="" class="media-list-link read">
                     <div class="media pd-x-20 pd-y-15">
                        <img src="{{asset('/backend')}}/assets/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                  ...
                  <a href="" class="media-list-link read">
                     <div class="media pd-x-20 pd-y-15">
                        <img src="{{asset('/backend')}}/assets/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
